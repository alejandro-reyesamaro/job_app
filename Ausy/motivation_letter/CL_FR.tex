...
\newcommand{\poste}{Ingénieur Développement C++ Embarqué H/F}
\newcommand{\where}{publiée sur le site web OuestJob :~}
...
ainsi que des tests de fonctionnalité et validation. 
Dans mon CV je résume les caractéristiques de \textit{Neurohipot} et \textit{POSL}, des logiciels que j'ai conçu et développé. Notamment, un des projets dans \textit{SCG} à été la conception et développement, de toutes pièces, d'un site web pour l'évaluation des niveaux de responsabilité sociale des petites entreprises au Costa Rica, où j'ai aussi élaboré le dessin web.
