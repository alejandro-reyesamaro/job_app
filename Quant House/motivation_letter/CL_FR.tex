...
\newcommand{\entreprise}{Quant House}
\newcommand{\poste}{Ingénieur Développement C++ Multithread H/F}
...
Dans ce projet, le parallélisme a été implémenté en utilisant \textit{MPI} et \textit{Multi-threading}. %de la librairie \textit{Boost}.
