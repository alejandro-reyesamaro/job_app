...
\vspace{40pt}
\begin{center}
\textcolor{gray}{\textit{ {\fontfamily{ppl}\selectfont Ci-joint : curriculum vitæ (FR et EN)}}}
\end{center}
...
\begin{letter}
{{\bf DTA Ingénierie}\\Nantes, France\\
\vspace{0.2in}
\textbf{Object :} Candidature au poste \textit{Développeur JAVA (H/F)}
}
...
Avant ma thèse, mon expérience m'a amené principalement à utiliser les technologies .NET de Microsoft et C\#, langage très proche à JAVA.
...
%des différents \textit{design patterns}.
...
En espérant pouvoir vous exprimer ma motivation dans le cadre d'un entretien, je vous prie de croire, Madame {\sc Feniet}, à l'expression de mes salutations distinguées.
