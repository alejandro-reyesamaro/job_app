...
\newcommand{\poste}{Développeur informatique .Net (H/F)}
\newcommand{\where}{publiée sur le site web \textit{lesjeudis} :~}
...
%En revanche, j'ai utilisé le langage JAVA pour toutes mes formations entant que développeur.
