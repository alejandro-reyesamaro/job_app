...
\begin{letter}
{{\bf Smart AdServer}\\Nantes, France\\
\vspace{0.2in}
\textbf{Object :} Candidature au poste \textit{FullStack Software Engineer -- C\# .Net/AngularJS}
}
...
\opening{Monsieur Flavien CORONINI,}

Je vous écris concernant l'offre d'emploi publié sur le site web LinkedIn : 
\textbf{FullStack Software Engineer -- C\# .Net/AngularJS}. 
...
Il est à noter qu'en tant qu'enseignant aux Universités de la Havane et de Nantes, j'ai enseigné pendant des années les langages C/C++/C\#, ainsi des différents \textit{design patterns}.
...
En espérant pouvoir vous exprimer ma motivation dans le cadre d'un entretien, je vous prie de croire, %Madame, 
Monsieur CORONINI, à l'expression de mes salutations distinguées.
